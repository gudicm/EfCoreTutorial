...
namespace EFCoreDatabaseFirstSample
{
    public class Startup
    {
        ...
        {
            // .UseSqlServer("IT-27105\\SQLEXPRESS;Database=BookStore;Trusted_Connection=True;");
            services.AddDbContext<BookStoreContext>(opts => opts.UseSqlServer(Configuration["ConnectionString:BooksDB"]));
            //services.AddDbContext<BookStoreContext>(opts => opts.UseSqlServer(@"IT-27105\\SQLEXPRESS;Database=BookStore;Trusted_Connection=True"));
